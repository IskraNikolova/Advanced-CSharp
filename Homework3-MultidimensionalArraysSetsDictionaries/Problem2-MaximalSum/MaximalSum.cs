namespace Problem2_MaximalSum
{
    ...
    public class MaximalSum
    {
        ...
        public static void Main()
        {
            ...
            FillTheMatrix(rows, column, matrix);
            ...
            PrintMatrix(bestRow, length, bestCol, matrix);
        }

        private static void FillTheMatrix(int rows, int column, int[,] matrix)
        {
        ...
        private static void PrintMatrix(int bestRow, int length, int bestCol, int[,] matrix)
        {
